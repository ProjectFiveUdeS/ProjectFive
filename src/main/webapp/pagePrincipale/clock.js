export class Clock{
    ...
    async updateClock(){
        ...
        let heure3 = Math.floor((debutExamEnSec - currentTimeEnSec)/(3600));
        let minutes3 = Math.floor(((debutExamEnSec - currentTimeEnSec)-(heure3*3600))/60);
        let secondes3 = Math.floor(((debutExamEnSec - currentTimeEnSec)-(heure3*3600)-(minutes3*60)));
        heure3 = (heure3 < 10 ? "0" : "") + heure3;
        minutes3 = (minutes3 < 10 ? "0" : "") + minutes3;
        secondes3 = (secondes3 < 10 ? "0" : "") + secondes3;
        if(currentTimeEnSec <= finExamEnSec && currentTimeEnSec >= debutExamEnSec)
            $$("labelTempsRestant").setValue(stringHeure2);
        else if(currentTimeEnSec <= debutExamEnSec)
            $$("labelTempsRestant").setValue("Début: " + heure3 + ":" + minutes3 + ":" + secondes3);
        else if(currentTimeEnSec >= finExamEnSec)
            $$("labelTempsRestant").setValue("Examen Terminé!");
        else
        ...
        {
            // On regarde si contenue dans liste sortie toilette
            let a = await this.selectSortieToilette(examenExtrait, ajd2);
            // On initialise tier exam
